          ...
          <div className="max-w-md mx-auto space-y-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Sign in to access your Wreckshop Social account
              </p>
            </div>
              ...
              <CardContent className="space-y-6 pt-6">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      className="p-0 h-auto text-sm text-[#00CFFF] hover:underline"
                    >
                      Forgot password?
                    </Button>
                  </div>
                ...
                <div className="space-y-3">
                  {oauthProviders.map((provider) => (
                    <Button
                      ...
                      type="button"
                      variant="outline"
                      onClick={() => redirectToStackAuth(provider.name.toLowerCase())}
                      disabled={loading}
                ...
                <div className="text-center text-sm text-muted-foreground">
                  ...
                  <Button
                    ...
                    className="p-0 h-auto text-[#00CFFF] hover:underline"
                    disabled={loading}
                  >
                    Sign up
                  </Button>
